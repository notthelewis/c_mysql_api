/*
 * C program to bind data to a prepared statement, then send it to MySQL's C API
 * Also has the option for single-query mode, which just allows you to send a SQL query straight to MySQL.
*/
