...
## Install script for the SS command inserter (need to get a better name)
...
# Install if command doesn't exist
install_not_exists() {
	if [ $1 = "Fedora" ]; then
...
# So far, this only identifies Debian and RHEL systems. Future support can be added easily, if required.
